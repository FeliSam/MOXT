...
export const routeMetadata = [
  ...
  { pattern: /^\/stars\/buy\/checkout\/[^/]+$/, title: 'Paiement Stars', eyebrow: 'MOXT Stars', back: '/stars/buy' },
  { pattern: /^\/stars\/buy$/, title: 'Packs Stars', eyebrow: 'MOXT Stars', back: '/stars' },
  { pattern: /^\/stars$/, title: 'MOXT Stars', eyebrow: 'Finances' },
  ...
  {
    pattern: /^\/videos\/publish$/,
    title: 'Publier une vidéo',
    eyebrow: 'Communauté',
    back: '/feed?type=video',
  },
  { pattern: /^\/feed$/, title: 'Fil d’actualité', eyebrow: 'Communauté' },
  { pattern: /^\/videos$/, title: 'Vidéos', eyebrow: 'Communauté' },
