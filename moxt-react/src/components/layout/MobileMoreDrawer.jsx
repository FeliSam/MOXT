...
export function MobileMoreDrawer({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[var(--z-nav-menu)] lg:hidden">
      ...
      <div
        className={`absolute inset-x-0 bottom-0 flex max-h-[88dvh] flex-col rounded-t-[1.4rem] border border-b-0 border-[var(--app-border)] bg-[var(--app-bg)] shadow-[var(--shadow-float)] ${
