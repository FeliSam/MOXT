...
export function BottomNavigation() {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className="bottom-nav-shell z-[var(--z-nav)] grid grid-cols-5 gap-0.5 rounded-[1rem] border border-[var(--app-border)] bg-[var(--app-surface)]/96 shadow-[var(--shadow-float)] backdrop-blur-xl lg:hidden"
