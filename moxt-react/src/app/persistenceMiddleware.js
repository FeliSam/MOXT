...
const persistenceMap = {
  ...
  platformModules: [{ key: 'moxt-platform-modules-v1', select: (state) => ({ flags: state.platformModules.flags, updatedAt: state.platformModules.updatedAt }) }],
  ...
  videos: [{ key: 'moxt-videos-v1', select: (state) => state.videos.items }],
  ...
  posts: [{ key: 'moxt-posts-v1', select: (state) => state.posts.items }],
...
const skipPersistence = new Set([
  ...
  'communications/preloadInboxMessages/pending',
  'communications/preloadInboxMessages/fulfilled',
  'communications/preloadInboxMessages/rejected',
  'stars/loadBalance/pending',
  'stars/loadBalance/fulfilled',
  'stars/loadBalance/rejected',
  'stars/loadHistory/pending',
  'stars/loadHistory/fulfilled',
  'stars/loadHistory/rejected',
  'stars/loadCatalog/pending',
  'stars/loadCatalog/fulfilled',
  'stars/loadCatalog/rejected',
  'stars/loadOverview/pending',
  'stars/loadOverview/fulfilled',
  'stars/loadOverview/rejected',
  'stars/quote/pending',
  'stars/quote/fulfilled',
  'stars/quote/rejected',
  'stars/consume/pending',
  'stars/consume/fulfilled',
  'stars/consume/rejected',
  'stars/purchase/pending',
  'stars/purchase/fulfilled',
  'stars/purchase/rejected',
