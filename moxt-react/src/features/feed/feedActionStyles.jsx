...
export const FEED_META_OVERLAY_CLASS =
  'pointer-events-none absolute inset-x-0 bottom-0 z-[5] bg-gradient-to-t from-black/70 via-black/25 to-transparent p-4 pt-16 pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] pr-16 text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.75)]'
