...
export const MESSAGES_FR_SOURCES = {
  ...
  'messages.messageActions': 'Actions du message',
  'messages.report': 'Signaler',
  'messages.reportTitle': 'Signaler ce message',
  'messages.reportToastTitle': 'Signalement envoyé',
  'messages.reportToastBody': 'Notre équipe va examiner ce message.',
  'messages.translate': 'Traduire',
  'messages.translateInto': 'Traduire en…',
  'messages.translateBack': 'Retour aux actions',
  ...
  'messages.autoTranslatedFrom': 'Traduit depuis {language}',
  ...
  'messages.activity.online': 'En ligne',
  'messages.activity.recent': 'Actif récemment',
  'messages.activity.seenMinutes': 'Vu il y a {minutes} min',
  'messages.activity.seenHours': 'Vu il y a {hours} h',
  'messages.activity.activeToday': "Actif aujourd'hui · {time}",
  'messages.activity.activeYesterday': 'Actif hier · {time}',
  'messages.activity.last': 'Dernière activité · {time}',
  'messages.assistant.name': 'Moxti',
  'messages.assistant.alwaysThere': 'Toujours là',
  'messages.assistant.preview': 'Comment puis-je vous aider aujourd’hui ?',
  'messages.assistant.subtitle': 'Assistant IA MOXT',
  'messages.assistant.greeting':
    'Bonjour — je suis Moxti. Je vous guide sur les transferts, le P2P, le marketplace, les colis, la vérif et le support. Posez une question ou choisissez une suggestion.',
  ...
  'messages.assistant.placeholder': 'Demandez quelque chose à Moxti…',
  'messages.assistant.sendAria': 'Envoyer à Moxti',
  'messages.assistant.sources': 'Sources: {list}',
  'messages.assistant.error': 'Moxti n’a pas pu répondre. {detail}',
