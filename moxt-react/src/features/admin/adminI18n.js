...
export const ADMIN_FR_SOURCES = {
  ...
  'admin.nav.stores': 'Langues stores',
  'admin.nav.feed': 'Fil vidéo',
  'admin.nav.avatar': 'Avatar',
  ...
  'admin.modules.avatar': 'Avatar',
  'admin.modules.avatarHint': 'Éditeur d’avatar (portraits, illustré), invitation à la connexion et badge. L’upload photo classique reste possible.',
  ...
  'admin.feed.title': 'Lecture du Fil',
  'admin.feed.description': 'Défauts globaux pour le son et le geste play/pause sur le Fil vidéo.',
  'admin.feed.hint': 'Ces réglages s’appliquent à tous les utilisateurs. Le navigateur peut encore forcer le muet au premier autoplay (politique iOS) : le Fil réessaie ensuite d’activer le son.',
  'admin.feed.soundOnByDefault': 'Son activé par défaut',
  'admin.feed.soundOnByDefaultHint': 'Les vidéos démarrent avec le son si le navigateur le permet.',
  'admin.feed.tapPausesVideo': 'Tap = pause / play',
  'admin.feed.tapPausesVideoHint': 'Un tap sur la vidéo en cours la met en pause et affiche le bouton lecture. Sinon, le tap bascule le mute.',
  'admin.feed.save': 'Enregistrer le Fil',
  'admin.feed.saved': 'Réglages du Fil enregistrés.',
  'admin.feed.saveFailed': 'Impossible d’enregistrer les réglages du Fil.',
  'admin.feed.updatedAt': 'Dernière mise à jour : {date}',
  'admin.avatar.title': 'Module Avatar',
  'admin.avatar.description': 'Éditeur d’avatar Moxt : styles proposés, invitation à la connexion et badge « Avatar ».',
  'admin.avatar.hint': 'Ces réglages s’appliquent à tous les utilisateurs. Les valeurs par défaut reproduisent le comportement actuel. Module désactivé : ni éditeur généré, ni invitation, ni badge ; l’upload photo classique reste possible.',
  'admin.avatar.enabled': 'Module Avatar activé',
  'admin.avatar.enabledHint': 'Éditeur d’avatar généré, invitation et badge. Même interrupteur que dans Modules.',
  'admin.avatar.disabledNotice': 'Module désactivé : les réglages ci-dessous sont conservés mais sans effet.',
  'admin.avatar.sections.styles': 'Styles disponibles',
  'admin.avatar.sections.prompt': 'Invitation à la connexion',
  'admin.avatar.sections.badge': 'Badge',
  'admin.avatar.sections.stats': 'Répartition des profils',
  'admin.avatar.portrait': 'Portrait (bibliothèque)',
  'admin.avatar.portraitHint': '60 portraits photoréalistes sur le CDN, choix par genre, teint et coiffure.',
  'admin.avatar.lorelei': 'Illustré (Lorelei)',
  'admin.avatar.loreleiHint': 'Avatar dessiné DiceBear Lorelei, enregistré en PNG sur le stockage.',
  'admin.avatar.photo': 'Photo perso',
  'admin.avatar.photoHint': 'Lien « Photo à la place » dans l’éditeur. L’upload classique des informations personnelles reste disponible.',
  'admin.avatar.atLeastOne': 'Au moins un style doit rester actif.',
  'admin.avatar.defaultStyle': 'Style par défaut de l’éditeur',
  'admin.avatar.defaultStyleHint': 'Onglet ouvert si l’utilisateur n’a pas encore d’avatar généré.',
  'admin.avatar.promptEnabled': 'Invitation « Personnaliser mon avatar »',
  'admin.avatar.promptEnabledHint': 'Fenêtre affichée après la connexion aux profils sans avatar (une fois par session au plus).',
  'admin.avatar.promptMaxShows': 'Nombre max d’affichages',
  'admin.avatar.promptMaxShowsHint': 'Par utilisateur, au total (1 à 10).',
  'admin.avatar.promptIntervalHours': 'Délai min entre deux (heures)',
  'admin.avatar.promptIntervalHoursHint': 'Temps minimal entre deux invitations (0 à 720 h).',
  'admin.avatar.promptDelaySeconds': 'Délai avant affichage (secondes)',
  'admin.avatar.promptDelaySecondsHint': 'Attente après l’arrivée dans l’app, le temps de charger les préférences (0 à 30 s).',
  'admin.avatar.badgeEnabled': 'Badge « Avatar »',
  'admin.avatar.badgeEnabledHint': 'Pastille sur les avatars créés avec l’éditeur (profil, informations personnelles, profil public).',
  'admin.avatar.statsPortrait': 'Portrait',
  'admin.avatar.statsLorelei': 'Illustré',
  'admin.avatar.statsPhoto': 'Photo',
  'admin.avatar.statsNone': 'Aucun',
  'admin.avatar.statsTotal': '{count} profils',
  'admin.avatar.statsRefresh': 'Actualiser',
  'admin.avatar.statsUnavailable': 'Statistiques indisponibles (migration non appliquée ou accès refusé).',
  'admin.avatar.save': 'Enregistrer l’avatar',
  'admin.avatar.saved': 'Réglages Avatar enregistrés.',
  'admin.avatar.saveFailed': 'Impossible d’enregistrer les réglages Avatar.',
  'admin.avatar.updatedAt': 'Dernière mise à jour : {date}',
  'admin.stores.title': 'Langue par store',
  'admin.stores.description':
    'Langue affichée au premier lancement (tant que l’utilisateur n’a pas choisi sa langue). Les fiches App Store / Play / RuStore restent à remplir dans chaque console.',
  'admin.stores.hint':
    'iOS et Google Play : français. RuStore : russe. Pour que l’APK RuStore soit détecté, compiler avec VITE_DISTRIBUTION_STORE=rustore.',
  'admin.stores.ios': 'App Store (iOS)',
  'admin.stores.iosHint': 'Application Capacitor iPhone / iPad.',
  'admin.stores.play': 'Google Play',
  'admin.stores.playHint': 'APK / AAB Android distribué via Google Play.',
  'admin.stores.rustore': 'RuStore',
  'admin.stores.rustoreHint': 'Même package Android, build destiné à RuStore.',
  'admin.stores.web': 'Web (moxtapp.ru)',
  'admin.stores.webHint': 'Site et PWA.',
  'admin.stores.save': 'Enregistrer les langues',
  'admin.stores.saved': 'Langues par store enregistrées.',
  'admin.stores.saveFailed': 'Impossible d’enregistrer les langues.',
  'admin.stores.updatedAt': 'Dernière mise à jour : {date}',
  ...
  'admin.stars.poolPersonalHint': 'Ex. 60 ★ / mois',
  'admin.stars.poolBusiness': 'Compte entreprise',
  'admin.stars.poolBusinessHint': 'Ex. 150 ★ / mois',
