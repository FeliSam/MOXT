...
export const es = {
  auth: {
    ...
    register: {
      ...
      helpIntro: "El código finaliza la creación de la cuenta. Proceso actual:",
      helpStep1:
        "En Verificación, para un número +7 elige SMS, Telegram o llamada (4 últimas cifras). Por correo, el código llega solo por e-mail. SMS: hasta 1–2 minutos; Telegram y correo: a menudo unos segundos.",
      helpStep2:
        "¿Sin código en el canal elegido? Cambia de método (SMS, Telegram, llamada) o usa «Recibir el código por correo». El reenvío solo está disponible tras el contador.",
      helpStep3:
      ...
      verify: {
        ...
        callTitle: "Confirma la llamada",
        callBody:
          "Contesta o deja sonar: introduce las 4 últimas cifras del número que llama a {phone}.",
        callBodyShort: "4 últimas cifras de quien llama a {phone}.",
        callCodeLabel: "4 últimas cifras del número que llama",
        sendingTitleCall: "Llamando…",
        telegramTitle: "Confirma por Telegram",
        telegramBody:
          "Se envió un código de 6 dígitos a {phone} por Telegram. Abre Telegram e introdúcelo. Solo un código a la vez: la cuenta se crea tras la confirmación.",
        telegramBodyShort: "Código Telegram enviado a {phone}.",
        telegramCodeLabel: "Código recibido en Telegram",
        sendingTitleTelegram: "Enviando Telegram…",
      },
      emailFallback: {
        ...
        smsResendLimitHint:
          "Puedes reenviar el código una vez (tras el contador), o recibirlo por correo de inmediato.",
        afterCooldownHint:
          "Reenvía el código o recíbelo por correo ahora.",
      },
      channel: {
        title: "¿Cómo quieres recibir tu código?",
        subtitle:
          "SMS, Telegram, llamada (4 últimos dígitos) o correo. El otro identificador se podrá confirmar más tarde en Seguridad para publicar.",
        smsTitle: "Por SMS",
        smsHint: "Código de 6 dígitos, normalmente en unos segundos.",
        telegramTitle: "Por Telegram",
        telegramHint: "Código de 6 dígitos en Telegram. El número +7 debe estar vinculado a una cuenta de Telegram.",
        callTitle: "Por llamada",
        callHint: "Una llamada breve: introduce las 4 últimas cifras del número que llama.",
      ...
      loginNoticePendingOtp: "Si el registro está completo, inicia sesión con tu número +7 y la contraseña elegida. Si no, introduce primero el código recibido arriba.",
      resendSms: "Reenviar SMS",
      resendTelegram: "Reenviar por Telegram",
      resendCall: "Volver a llamar",
      resendEmail: "Reenviar correo",
      resendCooldown: "Reenviar en {seconds}s",
      codeNotReceivedSms: "¿No recibiste el SMS?",
      codeNotReceivedTelegram: "¿No recibiste el código de Telegram?",
      codeNotReceivedCall: "¿No recibiste la llamada?",
      ...
      codeResentTelegram: "Se envió un nuevo código de Telegram a {phone}.",
      codeResentCall: "Se realizó una nueva llamada a {phone}.",
  ...
  nav: {
    ...
    parcelsAvailableAria: "Paquetes ({count} viajes disponibles)",
  ...
  stars: {
    eyebrow: "MOXT Stars",
    walletTitle: "Cartera Stars",
    walletDescription: "Pool bonus mensual + Paid Stars compradas, válidas en cualquier publicación.",
    buyCta: "Comprar Stars",
    buyTitle: "Packs MOXT Stars",
    buyDescription: "Pago en rublos. Las Stars se acreditan solo tras confirmar el pago.",
    buyPayRub: "Pago en rublos (₽)",
    buySecure: "Crédito tras confirmar el pago",
    buyChoosePack: "Elegir un pack",
    buyPerStar: "≈ {price} ₽ / ★",
    packPopular: "Popular",
    packBestValue: "Mejor oferta",
    packTotal: "{n} Stars en total",
    priceRub: "IVA incl.",
    purchaseLine: "Compra Stars",
    purchaseStatus: {
      pending: "Pendiente",
      paid: "Pagado",
      failed: "Fallido",
    ...
    businessWallet: "Empresa",
    paidBalance: "Paid Stars",
    paidHint: "Usables en todas tus publicaciones",
    totalBonus: "Bonus del mes",
    periodLabel: "Periodo: {period}",
    bonusSection: "Pool bonus mensual",
    bonusPoolSection: "Pool bonus mensual",
    bonusPoolPeriodHint: "El pool bonus solo baja cuando publicas. Se renueva el dia 1 de cada mes.",
    bonusPoolHint: "Stars gratis este mes, válidas en cualquier publicación",
    bonusPoolShort: "Pool bonus",
    bonusPoolCombinedHint: "{personal} personal + {business} empresa",
    personalBonusShort: "Bonus personal",
    businessBonusShort: "Bonus empresa",
    personalBonusPool: "Pool bonus personal",
    businessBonusPool: "Pool bonus empresa",
    bonusAvailable: "Bonus disponibles",
    bonusEmpty: "Cuota agotada o no inicializada",
    comingSoonTitle: "Próximamente",
    refresh: "Actualizar cartera",
    bonusLeft: "{n} Bonus restantes este mes",
    historyTitle: "Historial",
    historyEmpty: "Aún no hay movimientos.",
    historyPageRange: "{from}–{to} / {total}",
    historyPrev: "Anterior",
    historyNext: "Siguiente",
    historyPoolGrant: "Asignación mensual del pool bonus",
    historyPurchase: "Compra de Stars",
    historySpendPublish: "Publicación {category}",
    historySpendBoost: "Boost de publicación",
    historySpendStatus: "Estado prolongado",
    historySpendGeneric: "Uso de Stars",
    historyCredit: "Crédito Stars",
    historyGiftReceived: "Stars recibidas",
    historyGiftSent: "Stars regaladas",
    historyReferral: "Padrinazgo",
    comingSoon: "Las cuotas Stars aún no están activas. El uso gratuito no cambia.",
    offline: "Cartera no disponible sin conexión.",
    buyPack: "Elegir",
    noPacks: "No hay packs disponibles.",
    purchasesTitle: "Tus compras",
    purchasePendingTitle: "Pago pendiente",
    purchasePendingBody: "Estado: {status}. Las Stars se acreditarán tras la confirmación.",
    purchaseFailedTitle: "Compra imposible",
    purchaseFailedBody: "Reintenta o contacta con soporte.",
    checkoutTitle: "Pago",
    checkoutEyebrow: "MOXT Stars",
    checkoutDescription: "Revisa tu pedido y confirma el pago de prueba.",
    checkoutTestBanner: "Modo prueba",
    checkoutTestHint: "Sin cargo real. Usa los botones para simular un pago exitoso o fallido.",
    checkoutOrder: "Pedido",
    checkoutAmount: "Importe",
    checkoutRef: "Ref. {ref}",
    checkoutPayment: "Pago de prueba",
    checkoutPaymentHint: "Confirma para acreditar tus Stars o simula un fallo.",
    checkoutConfirmTest: "Confirmar (prueba)",
    checkoutSimulateFail: "Simular fallo",
    checkoutCancel: "Cancelar y volver a packs",
    checkoutSuccessTitle: "Pago confirmado",
    checkoutSuccessBody: "Se han acreditado {n} Stars en tu cartera.",
    checkoutFailedTitle: "Pago fallido",
    checkoutFailedBody: "El pago no se completó. Puedes reintentar.",
    checkoutRetry: "Reintentar",
    checkoutNotFound: "Pedido no encontrado",
    checkoutError: "No se pudo completar el pago.",
    backToPacks: "Volver a packs",
    confirmTitle: "¿Usar Paid Stars?",
    confirmBody: "Se consumirá {split}. Confirma para continuar.",
    confirmPay: "Confirmar",
    gift: {
      trigger: "Regalar Stars",
      title: "Regalar MOXT Stars",
      description: "Envía Paid Stars a {name} como agradecimiento.",
      recipientFallback: "esta suscripción",
      balance: "Saldo Paid: {n} ★",
      messagePlaceholder: "Mensaje opcional (máx. 120 caracteres)",
      confirm: "Regalar {amount} ★",
      successTitle: "Stars regaladas",
      successBody: "Has regalado {amount} ★ a {name}.",
      failedTitle: "Regalo imposible",
      failedBody: "No se pudieron regalar Stars por ahora.",
    },
    ...
    included: "Incluido",
    paidCost: "{n} Paid",
    insufficientTitle: "Stars insuficientes",
    insufficientBody: "Compra un pack o espera el reinicio del pool bonus.",
    quotaBadge: "{remaining}/{quota} restantes",
    totalAvailable: "Total disponible",
    totalAvailableHint: "Pool bonus primero, luego Paid Stars",
    totalAvailableHintLinked:
      "Total personal + empresa. Primero el bonus del perfil, luego el otro pool, luego Paid Stars compartidas.",
    pricingTitle: "Tarifas Stars",
    pricingDebitHint: "Las Stars del pool mensual se debitan antes que las Paid Stars.",
    pricingPoolGrant: "{n} ★ gratis cada mes",
    pricingPublishSection: "Publicaciones estándar",
    pricingFormulasSection: "Fórmulas destacadas (al publicar)",
    pricingFormulasHint: "Precios para un anuncio marketplace; tarifa vídeo si difiere.",
    pricingVideoCost: "Vídeo: {n} ★",
    pricingStatusSection: "Estados",
    pricingBoostSection: "Boost desde Mis publicaciones",
    pricingBoostStandard: "Estándar",
    pricingBoostVideo: "Vídeo",
    pricingChipPool: "Pool {n} ★/mes",
    pricingChipPoolBusiness: "Empresa {n} ★/mes",
    pricingChipPublish: "Pub. {n} ★",
    pricingChipVideo: "Vídeo {n} ★",
    pricingChipStatus: "Estado {n} ★",
    pricingChipBoost: "Boost desde {n} ★",
    walletSplitBonus: "{n} bonus",
    walletSplitPersonalBonus: "{n} bonus personal",
    walletSplitBusinessBonus: "{n} bonus empresa",
    walletSplitPaid: "{n} paid",
    formulas: {
      title: "Fórmula de publicación",
      costStars: "{n} ★",
      standard: "Estándar",
      standardDesc: "Publicación clásica en el feed",
      featured_24h: "Destacado 24 h",
      featured_24hDesc: "Publicación + visibilidad prioritaria 24 h",
      featured_7d: "Destacado 7 d",
      featured_7dDesc: "Publicación + visibilidad prioritaria 7 días",
    },
    boost: {
      title: "Impulsar publicación",
      description: "Aumenta la visibilidad de «{label}» en el feed.",
      feedHint: "Prioridad en el feed de actualidad",
      cancel: "Cancelar",
      successTitle: "Publicación impulsada",
      successBody: "Tu contenido está destacado en el feed.",
      failedTitle: "Impulso imposible",
      failedBody: "Reintenta o comprueba tu saldo Stars.",
    },
    categories: {
  ...
  share: {
    ...
    inviteCountMany: "personas invitadas",
    starsEarnedLabel: "Stars ganadas",
    starsPerInviteHint: "+{n} ★ por persona invitada",
    copyLink: "Copiar enlace",
    copied: "Copiado",
    share: "Compartir",
    publicProfile: "Mi perfil público",
    qrProfile: "Código QR del perfil",
    qrBusiness: "Código QR de la empresa",
    qrToShare: "Código QR para compartir",
    showProfileQr: "Mostrar el código QR del perfil",
    showBusinessQr: "Mostrar el código QR de la empresa",
    profileSubtitle: "Perfil de MOXT",
    badge: {
    ...
    hints: {
      invite: "Escanea para unirte a MOXT",
      profile: "Escanea para ver mis publicaciones",
      profileMember: "Escanea para ver este perfil en MOXT",
      business: "Escanea para descubrir esta empresa",
  ...
  messages: {
    ...
    composerPlusAria: "Adjuntar un archivo o un contacto",
    composerPlusClose: "Cerrar el menú de adjuntos",
    composerAttachFile: "Archivo",
    composerAttachContact: "Contacto",
    ...
    maxVideosTitle: "Demasiados videos",
    maxVideos: "Solo un video por mensaje.",
    ...
    translateFromHint: "Mensaje en {language} — traducir a…",
    translateRussianFallback: "Ruso (idioma común)",
    translateBack: "Volver a las acciones",
    translatedInto: "Traducido al {language}",
    showOriginal: "Mostrar original",
    showTranslation: "Mostrar traducción",
    autoTranslated: "Traducido automáticamente",
    autoTranslatedFrom: "Traducido del {language}",
    ...
    openListing: "Abrir ficha",
      replyToListing: "Responder al anuncio",
      linkedListing: "Anuncio vinculado",
    empty: {
    ...
    contact: {
      pickerTitle: "Compartir un contacto",
      pickerHint: "Elige entre tus seguidos y seguidores para enviarlo en la conversación.",
      ...
      fallbackName: "Contacto MOXT",
      openProfile: "Ver perfil",
      preview: "👤 {name}",
      searchLabel: "contacto perfil"
    },
  ...
  dashboard: {
    ...
    starsStrip: {
      eyebrow: "MOXT Stars",
      balance: "{n} ★ disponibles",
      loading: "Cargando saldo…",
      hint: "{n} Paid Stars · Abrir cartera",
    },
    overview: {
  ...
  security: {
    ...
    phone: {
      ...
      sendCodeTelegram: "Enviar código de Telegram",
      sendCodeCall: "Recibir la llamada",
      sentAlert: "Foi enviado un código de 6 dígitos para {phone} por SMS.",
      sentAlertTelegram: "Se envió un código de 6 dígitos a {phone} en Telegram.",
      sentAlertCall: "Llegará una llamada a {phone}. Introduce las 4 últimas cifras del número que llama.",
      otpLabel: "Código recebido por SMS",
      otpLabelTelegram: "Código recibido en Telegram",
      otpLabelCall: "4 últimas cifras del llamante",
      channelTitle: "¿Cómo recibir el código?",
      codeSentBodyTelegram: "El código de Telegram se envió a {phone}. El número debe estar vinculado a una cuenta de Telegram.",
      codeSentBodyCall: "Llegará una llamada corta a {phone}. Introduce las 4 últimas cifras del número llamante.",
      testChannelsCta: "Probar SMS, Telegram o llamada (superadmin)",
      testChannelsHint:
        "Modo de prueba superadmin: el número ya puede estar confirmado. Usa tu +7 (Telegram vinculado y una llamada real para FlashCall). No hace falta un segundo SIM.",
      testChannelsCancel: "Cerrar la prueba",
      ...
      assistSubmit: "Enviar solicitud",
      assistSentTitle: "Solicitud enviada",
      assistSentBody: "Un administrador revisará tu número. Serás notificado tras el tratamiento.",
      assistPendingTitle: "Solicitud en curso",
      assistPendingBody: "Tu solicitud para {phone} ya está pendiente del equipo MOXT."
    },
    toasts: {
  ...
  profile: {
    ...
    personal: {
      ...
      toastAvatarBody: "Tu foto de perfil ha sido actualizada.",
      toastAvatarSaveFailBody: "La foto se subió pero no se pudo guardar en tu perfil. Pulsa Guardar.",
      toastAvatarRemovedTitle: "Foto eliminada",
      toastAvatarRemovedBody: "Tu foto de perfil ha sido eliminada.",
      ...
      coverStyleTitle: "Banner Moxt",
      coverStyleHint: "Visible en tu perfil público si no tienes foto de portada.",
      coverStylePick: "Elegir un estilo",
      editBanner: "Modificar el banner",
      coverStyleApply: "Aplicar",
      coverStyleMan: "Hombre",
      coverStyleWoman: "Mujer",
      coverStyleActive: "Activo",
    ...
    bannerEditor: {
      title: "Tu banner",
      displayTitle: "Tu banner",
      tagline: "Elige una portada que se parezca a ti.",
      previewAlt: "Vista previa del banner",
      genderAria: "Colección de banners",
      woman: "Mujer",
      man: "Hombre",
      sectionStyle: "Estilo",
      hintStyle: "Elige un estilo",
      hint: "Se muestra en tu perfil mientras no tengas foto de portada.",
      random: "Aleatorio",
      save: "Guardar",
      cancel: "Cancelar",
      photoInstead: "Usar una foto",
      photoFailTitle: "Error al subir",
      photoFailBody: "No se pudo subir la foto de portada. Inténtalo de nuevo.",
      currentStyle: "Estilo actual:",
      open: "Editar banner",
      styles: {
        'business-a-mesh': "Malla turquesa",
        'business-b-editorial': "Editorial oscuro",
        'business-c-glass': "Cristal fintech",
        'business-d-topo': "Topo esmeralda",
        'woman-a-silk': "Seda ciruela",
        'woman-b-glass': "Cristal lavanda",
        'woman-c-blush': "Floral rosado",
        'man-a-steel': "Acero turquesa",
        'man-b-topo': "Topo esmeralda",
        'man-c-mesh': "Malla medianoche",
        'woman-d-prune': "Olas ciruela y rosa",
        'man-d-prune': "Olas ciruela noche",
      },
    },
    avatarEditor: {
      title: "Mi avatar",
      eyebrow: "Avatar ilustrado · Lorelei",
      subtitle: "Elige tu tono de piel, peinado y accesorios. El avatar será tu foto de perfil.",
      open: "Editar avatar",
      openAria: "Editar avatar",
      previewAlt: "Vista previa del avatar",
      sectionSkin: "Tono de piel",
      sectionHair: "Peinado",
      sectionHairColor: "Color de pelo",
      sectionEyes: "Ojos",
      ...
      cancel: "Cancelar",
      photoInstead: "Usar una foto",
      skinOption: "Tono {index}",
      hairOption: "Peinado {index}",
      eyesOption: "Ojos {index}",
      colorOption: "Color {index}",
      cdnHint: "Tu avatar se convierte en imagen y se aloja en el CDN de Moxt.",
      displayTitle: "Tu avatar",
      tagline: "Crea un retrato que se parezca a ti.",
      tabsAria: "Categorías del avatar",
      tabFace: "Rostro",
      tabHair: "Peinado",
      tabAccessories: "Accesorios",
      hintSkin: "Elige tu tono de piel",
      hintEyes: "Dale carácter a tu mirada",
      hintHair: "Elige tu estilo",
      hintHairColor: "Tono natural o atrevido",
      hintAccessories: "Activa tus detalles",
      hintBackground: "El ambiente de tu retrato",
      styleAria: "Estilo de avatar",
      stylePortrait: "Retrato",
      styleIllustrated: "Ilustrado",
      sectionGender: "Género",
      genderF: "Mujer",
      genderM: "Hombre",
      portraitBadge: "Avatar",
      portraitBadgeTitle: "Avatar creado con el editor de Moxt",
      tones: {
        t1: "Muy clara (porcelana)",
        t2: "Clara",
        t3: "Oliva clara",
        t4: "Morena",
        t5: "Marrón cálido",
        t6: "Marrón oscuro profundo",
      },
      hairstyles: {
        "f-long-waves": "Largo ondulado",
        "f-bun": "Moño bajo",
        "f-curls": "Rizado",
        "f-bob": "Bob",
        "f-braids": "Trenzas",
        "m-short": "Corto texturizado",
        "m-waves": "Ondas hacia atrás",
        "m-fade": "Degradado corto",
        "m-buzz": "Rapado",
        "m-curls": "Rizos medianos",
      },
      prompt: {
        eyebrow: "Nuevo",
        title: "Ponle cara a tu perfil",
        body: "Elige un retrato elegante en segundos, o usa tu propia foto.",
        cta: "Personalizar mi avatar",
        later: "Más tarde",
        previewAlt: "Ejemplos de retratos",
      },
      toastSavedTitle: "Avatar guardado",
      toastSavedBody: "Tu avatar es ahora tu foto de perfil.",
      toastFailTitle: "Error al guardar",
      toastFailBody: "No se pudo subir el avatar. Inténtalo de nuevo.",
    },
    roles: {
      user: "Usuario",
  ...
  videos: {
    feed: {
      eyebrow: "Comunidad",
      title: "Videos",
      description: "Videos publicados por empresas MOXT.",
      publish: "Publicar un video",
      emptyTitle: "Sin videos",
      emptyDescription: "Los videos de empresas verificadas aparecerán aquí.",
      playErrorTitle: "Reproducción imposible",
      playErrorBody:
        "Este archivo no se puede reproducir aquí (a menudo un MOV HEVC de iPhone). Vuelve a publicarlo: MOXT lo convierte automáticamente, o graba en modo «Compatibilidad» en iPhone.",
    },
    publish: {
      eyebrow: "Empresa",
      title: "Publicar un video",
      description: "Solo para empresas verificadas con el módulo Marketplace.",
      back: "Volver",
      gateHint: "Crea o verifica tu empresa y activa Marketplace para publicar un video.",
      setupBusiness: "Configurar mi empresa",
      pickFile: "Elegir un video",
      preparing: "Preparando…",
      preparingProgress: "Conversión… {percent}%",
      previewEmpty: "Vista previa del video",
      submit: "Publicar",
      uploading: "Subiendo… {percent}%",
      successTitle: "Video publicado",
      successMessage: "Tu video es visible en el feed y el catálogo.",
      transcodedTitle: "Video convertido",
      transcodedMessage:
        "El archivo se convirtió a MP4 H.264 para reproducirse en todos los dispositivos.",
      fields: {
        file: "Archivo de video (mp4, mov, webm… máx. 90 s)",
        title: "Título",
        caption: "Leyenda",
      },
      errors: {
        fileType: "Formato no compatible. Usa mp4, mov (iPhone), webm, m4v, 3gp o mkv.",
        tooLong: "El video supera {max} segundos.",
        tooLarge: "Archivo demasiado grande (máx. 220 MB).",
        readFailed: "No se pudo leer este archivo de video.",
        needCompatible:
          "Este archivo (a menudo MOV HEVC de iPhone) no se puede leer en este navegador. En iPhone: Ajustes → Cámara → Formatos → «Compatibilidad» (o exporta en MP4) y reintenta. En Safari iPhone se ofrece conversión automática.",
        convertFailed:
          "Conversión imposible. Reintenta con un video más corto, o en iPhone: Ajustes → Cámara → Formatos → «Compatibilidad» (MP4).",
        titleRequired: "Título obligatorio.",
        fileRequired: "Añade un video.",
        businessBlocked: "Publicación reservada a empresas elegibles.",
  ...
  parcels: {
    ...
    detail: {
      ...
      toast: {
        ...
        releasedTitle: "Kg liberados",
        releasedBody: "{kg} kg están disponibles de nuevo en tu anuncio.",
      },
      ...
      requests: {
        ...
        releaseKg: "Liberar {kg} kg",
        releaseHint: "Si el solicitante no tomó el espacio, libera los kg para otros.",
        releaseConfirmTitle: "¿Liberar esta reserva?",
        releaseConfirmBody: "{kg} kg volverán a estar disponibles en tu anuncio.",
      },
      message: {
        greeting: "Olá {name},",
  ...
  marketplace: {
    ...
    page: {
      ...
      emptyDescription: "Prueba a ampliar la búsqueda o publica tu anuncio ahora.",
      feed: {
        forYou: "Para ti",
        forYouHint: "Según favoritos, visitas y vendedores seguidos.",
        trending: "Tendencias",
        trendingHint: "Anuncios que más interés despiertan ahora.",
        fresh: "Novedades",
        freshHint: "Las publicaciones más recientes, sin apilarlas solo por fecha.",
        discover: "Descubrir",
        discoverHint: "Una mezcla de categorías, no una lista cronológica.",
        results: "Resultados",
        resultsHint: "Ordenados por relevancia, interés y proximidad.",
      },
    },
    detail: {
  ...
  publish: {
    ...
    parcel: {
      ...
      fields: {
        ...
        travelProofHelpAria: "Consejos para el billete de avión",
        travelProofHelpTitle: "Cómo preparar tu billete",
        travelProofHelpBody:
          "Puedes ocultar o difuminar el número de billete / reserva. MOXT no lo necesita.",
        travelProofHelpItem1: "Itinerario (aeropuertos / ciudades)",
        travelProofHelpItem2: "Fechas del viaje",
        travelProofHelpItem3: "Nombre del pasajero",
        travelProofHelpTip:
          "Un billete parcialmente oculto sigue siendo válido si estos datos son legibles.",
        travelProofHelpClose: "Entendido",
  ...
  transfers: {
    ...
    receipt: {
      header: "MOXT - RECIBO DE TRANSFERENCIA",
      title: "Recibo de transferencia",
      reference: "Referencia: {id}",
      referenceLabel: "Referencia",
      status: "Estado: {status}",
      statusUnknown: "No definido",
      direction: "Dirección: {direction}",
      directionLabel: "Dirección",
      business: "Empresa: {name}",
      businessLabel: "Empresa",
      notProvided: "No indicado",
      sender: "Remitente: {name}",
      senderLabel: "Remitente",
      recipient: "Destinatario: {name}",
      recipientLabel: "Destinatario",
      amountSent: "Importe enviado: {amount}",
      amountSentLabel: "Importe enviado",
      fees: "Comisión ({percent}%): {amount}",
      feesLabel: "Comisión ({percent}%)",
      totalPaid: "Total pagado: {amount}",
      totalPaidLabel: "Total pagado",
      amountReceived: "Importe recibido: {amount}",
      amountReceivedLabel: "Importe recibido",
      createdAt: "Creado el: {date}",
      processing: "PROCESAMIENTO",
      generatedLocally: "Documento generado localmente por MOXT.",
      generatedBy: "Documento generado por MOXT",
      windowTitle: "Recibo {id}",
      printHint: "Utilice \"Guardar como PDF\" en el cuadro de impresión.",
    ...
    new: {
      ...
      fees: "comisiones",
      premium: "Premium",
      premiumTitle: "Socio destacado por MOXT",
      dynamicRate: "Dinámico",
      dynamicRateTitle: "Tipo actualizado en vivo",
      transferCount: "{count} transferencias",
      transferCountTitle: "{count} transferencia(s) completada(s) contabilizadas",
      ...
      sbpBankHint: "Con SBP puedes enviar o recibir desde cualquier banco ruso.",
      otherSbpBank: "Otro banco (SBP)",
    ...
    detail: {
      ...
      contact: {
        menu: "Escribir",
        clientOption: "Cliente · {name}",
        businessOption: "Empresa · {name}",
        clientHint: "Persona que inició la transferencia",
        businessHint: "Socio / exchanger del transfer",
        clientFallback: "Cliente",
        businessFallback: "Empresa socia",
      },
      copiedTitle: "Copiado",
      copiedMessage: "{label} copiado para a área de transferencia.",
  ...
  p2p: {
    ...
    page: {
      ...
      accept: "Aceitar",
      swipeToAccept: "Deslizar para aceptar",
      detail: "Detalhe",
    ...
    detail: {
      ...
      manageOffer: "Gestionar la oferta",
      editOffer: "Modificar la oferta",
      archiveOffer: "Archivar la oferta",
      reactivateOffer: "Republicar la oferta",
      manageNote:
        "Modifica el importe, la tasa o las modalidades. Archivar quita la oferta del catálogo activo.",
      archiveToastTitle: "Oferta archivada",
      archiveToastMessage: "La oferta ya no aparece en las ofertas activas.",
      reactivateToastTitle: "Oferta republicada",
      reactivateToastMessage: "La oferta vuelve a ser visible en el catálogo.",
    ...
    order: {
      status: {
        created: "Esperando al vendedor",
        sellerAccepted: "Listo para pagar",
        waitingPayment: "Pago enviado",
        buyerReceiveDetails: "Datos de recepción del comprador",
        completed: "Concluída",
        cancelled: "Cancelada",
      ...
      complete: "Concluir",
      cancel: "Cancelar",
      acceptAvailability: "Confirmar que estoy disponible",
      ...
      hint: {
        ...
        buyerWaitSeller: "Espera a que {name} confirme su disponibilidad antes de pagar.",
        sellerAcceptRequest: "{name} aceptó tu oferta. Confirma que estás disponible para el intercambio.",
      ...
      confirm: {
        acceptSellerTitle: "¿Confirmar que estás disponible?",
        acceptSellerBody: "El comprador podrá entonces pagar. Confirma solo si puedes honrar el intercambio ahora.",
        acceptSellerCta: "Estoy disponible",
      ...
      payToHint:
        "Pague únicamente {amount} a este número / cuenta, con el método indicado. El nombre del emisor debe coincidir con el apellido de la cuenta ({lastName}). Si no, deje un comentario para precisarlo.",
      threadTitle: "Comentarios",
      threadHint: "Precisiones del intercambio (nombre distinto, referencia, plazo…).",
      threadPlaceholder: "Escribir un comentario…",
      threadEmpty: "Aún no hay comentarios.",
      threadSend: "Enviar",
      threadYou: "Usted",
      threadOther: "Interlocutor",
      ...
      buyerPayToHint: "Envía {currency} solo a estos datos, con el método indicado.",
      buyerReceive: {
  ...
  admin: {
    ...
    modules: {
      avatar: "Avatar",
      avatarHint: "Editor de avatar (retratos, ilustrado), invitación al iniciar sesión e insignia. La subida clásica de foto sigue disponible.",
    },
    avatar: {
      title: "Módulo Avatar",
      description: "Editor de avatar de Moxt: estilos disponibles, invitación al iniciar sesión e insignia «Avatar».",
      hint: "Estos ajustes se aplican a todos los usuarios. Los valores por defecto reproducen el comportamiento actual. Con el módulo desactivado: sin editor generado, sin invitación ni insignia; la subida clásica de foto sigue disponible.",
      enabled: "Módulo Avatar activado",
      enabledHint: "Editor de avatar generado, invitación e insignia. Mismo interruptor que en Módulos.",
      disabledNotice: "Módulo desactivado: los ajustes de abajo se conservan pero no tienen efecto.",
      portrait: "Retrato (biblioteca)",
      portraitHint: "60 retratos fotorrealistas en el CDN, elegidos por género, tono de piel y peinado.",
      lorelei: "Ilustrado (Lorelei)",
      loreleiHint: "Avatar dibujado DiceBear Lorelei, guardado como PNG en el almacenamiento.",
      photo: "Foto propia",
      photoHint: "Enlace «Usar una foto» en el editor. La subida clásica en la información personal sigue disponible.",
      atLeastOne: "Al menos un estilo debe seguir activo.",
      defaultStyle: "Estilo por defecto del editor",
      defaultStyleHint: "Pestaña abierta si el usuario aún no tiene avatar generado.",
      promptEnabled: "Invitación «Personalizar mi avatar»",
      promptEnabledHint: "Ventana mostrada tras iniciar sesión a perfiles sin avatar (como máximo una vez por sesión).",
      promptMaxShows: "Número máximo de visualizaciones",
      promptMaxShowsHint: "Por usuario, en total (1 a 10).",
      promptIntervalHours: "Intervalo mínimo entre dos (horas)",
      promptIntervalHoursHint: "Tiempo mínimo entre dos invitaciones (0 a 720 h).",
      promptDelaySeconds: "Retraso antes de mostrar (segundos)",
      promptDelaySecondsHint: "Espera tras entrar en la app, mientras cargan las preferencias (0 a 30 s).",
      badgeEnabled: "Insignia «Avatar»",
      badgeEnabledHint: "Distintivo en los avatares creados con el editor (perfil, información personal, perfil público).",
      statsPortrait: "Retrato",
      statsLorelei: "Ilustrado",
      statsPhoto: "Foto",
      statsNone: "Ninguno",
      statsTotal: "{count} perfiles",
      statsRefresh: "Actualizar",
      statsUnavailable: "Estadísticas no disponibles (migración no aplicada o acceso denegado).",
      save: "Guardar avatar",
      saved: "Ajustes de avatar guardados.",
      saveFailed: "No se pudieron guardar los ajustes de avatar.",
      updatedAt: "Última actualización: {date}",
      sections: {
        styles: "Estilos disponibles",
        prompt: "Invitación al iniciar sesión",
        badge: "Insignia",
        stats: "Perfiles por estilo",
      },
    },
    content: {
      businesses: "Empresas",
  ...
  reviews: {
    ...
    publishedTitle: "A sua avaliação foi publicada",
    publishedHint: "Edite ou elimine-a na lista de avaliações à direita.",
    cancelEdit: "Cancelar",
    ...
    memberFallback: "Membro MOXT",
    summaryTotal: "{count} avaliaciones en total",
    actions: {
      edit: "Editar",
      delete: "Eliminar",
      viewPublication: "Ver publicación",
      viewTarget: "Ver ficha",
      deleteConfirmTitle: "¿Eliminar tu reseña?",
      deleteConfirmBody: "Esta eliminación es definitiva. Podrás publicar una nueva reseña si sigues siendo elegible.",
      reply: "Responder",
      editReply: "Editar respuesta",
      contest: "Impugnar",
      replyPlaceholder: "Responde de forma profesional a esta reseña…",
      publishReply: "Publicar respuesta",
      contestPlaceholder: "Explica por qué esta reseña te parece injusta o no conforme (mín. 10 caracteres)…",
      submitContest: "Enviar impugnación",
    },
    card: {
      publicationFallback: "Publicación",
      ownerReply: "Respuesta de {name}",
      ownerFallback: "el propietario",
      disputeReasonTitle: "Motivo de impugnación",
    },
    reasons: {
  ...
  notificationsFeed: {
    ...
    transferUpdatedBody: "Tu operación {id} está ahora {status}.",
    paymentDeclared: "Pago declarado",
    paymentDeclaredBody: "El cliente declaró el pago (con comprobante) para {id}.",
    paymentReceived: "Pago recibido",
    paymentReceivedBody: "El cambista confirmó la recepción de fondos para {id}.",
    payoutConfirmed: "Transferencia realizada",
    payoutConfirmedBody:
      "El cambista envió los fondos y adjuntó el comprobante de pago para {id}. Puedes confirmar la recepción.",
    transferCompletedStaffBody: "La transferencia {id} se marcó como completada.",
    ...
    businessPendingReview: "Empresa por validar",
    businessPendingReviewBody: "« {name} » acaba de crearse y espera validación.",
    ...
    fanOutP2pBody: "{amount} {from} → {to} · tasa {rate} · {method}",
    fanOutPost: "Nueva publicación",
    fanOutBusiness: "Nueva empresa",
    fanOutBusinessBody: "« {name} » acaba de crearse y está disponible en el directorio MOXT.",
    someone: "Alguien",
    ...
    transferCancelledActorBusiness: "la empresa",
    transferCancelledActorStaff: "el equipo MOXT",
    ...
    parcelReservationReleased: "Reserva de paquete liberada",
    parcelReservationReleasedBody: "El transportista liberó {kg} kg no utilizados en tu solicitud.",
    ...
    starsPurchase: "Compra de Stars",
    starsPurchaseBody: "Se han acreditado {n} ★ en tu cartera.",
    starsCredit: "Stars añadidas",
    starsCreditBody: "Se han añadido {n} ★ a tu cartera.",
    starsReferral: "Padrinazgo Stars",
    starsReferralBody: "{n} ★ por un ahijado confirmado.",
    starsPool: "Pool de bonus",
    starsPoolBody: "Se añadieron {n} ★ bonus este mes.",
    starsGiftReceived: "Stars recibidas",
    starsGiftReceivedBody: "Has recibido {n} ★.",
    starsGiftSent: "Stars regaladas",
    starsGiftSentBody: "Has regalado {n} ★.",
    starsSpend: "Stars usadas",
    starsSpendBody: "Se usaron {n} ★.",
  },
  help: {
    page: {
  ...
  confirmDialog: {
    ...
    subjectLabel: "Publicación",
    publication: {
      delete: {
        title: "¿Eliminar esta publicación?",
        descriptionListing: "Desaparecerá definitivamente de tu perfil y del Marketplace.",
        description: "Desaparecerá definitivamente de tu perfil y de MOXT.",
        confirm: "Eliminar",
      },
      archive: {
        title: "¿Archivar esta publicación?",
        description: "Ya no será visible en tu perfil ni en los feeds. Podrás volver a publicarla desde la pestaña Archivadas.",
        confirm: "Archivar",
      },
      republish: {
        title: "¿Volver a publicar esta publicación?",
        description: "Volverá a ser visible en tu perfil y en los feeds de MOXT.",
        confirm: "Volver a publicar",
      },
      duplicate: {
        title: "¿Duplicar esta publicación?",
        description: "Se añadirá una copia a tus publicaciones. El original no cambia.",
        confirm: "Duplicar",
      },
      markSold: {
        title: "¿Marcar como vendido?",
        description: "El anuncio pasará a «Vendido» y ya no se ofrecerá para la compra en el Marketplace.",
        confirm: "Marcar como vendido",
      },
      boost: {
        title: "¿Destacar esta publicación?",
        description: "Se destacará en los feeds durante {duration}. No se descontará ninguna estrella.",
        confirm: "Destacar",
      },
    },
    subscription: {
      unsubscribe: {
        ...
        description: "Ya no recibirás las nuevas publicaciones de {name}.",
        confirm: "Cancelar suscripción",
      },
      notifyPref: {
        title: "¿Cambiar las notificaciones?",
        description: "Notificaciones de {name}: {pref}.",
        confirm: "Guardar",
      },
      blockMessages: {
        title: "¿Bloquear los mensajes?",
        description: "{name} ya no podrá enviarte mensajes. Podrás desbloquearlo en cualquier momento.",
        confirm: "Bloquear",
      },
      unblockMessages: {
        title: "¿Desbloquear los mensajes?",
        description: "{name} podrá volver a enviarte mensajes.",
        confirm: "Desbloquear",
      },
      unban: {
        title: "¿Levantar la expulsión?",
        description: "{name} podrá volver a suscribirse a tus publicaciones.",
        confirm: "Levantar expulsión",
      },
      removeSubscriber: {
        confirm: "Quitar",
      },
  ...
  coverBanner: {
    ...
    onMoxt: "Presente en Moxt",
    yourNetwork: "Tu red",
    yourBusinessNetwork: "Tu red de negocios",
  },
}
