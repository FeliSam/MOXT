...
export const es = {
  ...
  share: {
    ...
    eyebrow: "Partilha",
    description: "Um só lugar para convidar amigos o compartir o tu perfil MOXT.",
  ...
  dashboard: {
    ...
    discovery: {
      ...
      recentTrips: "Viagens recentes con quilos disponibles.",
      kgAvailable: "{kg} kg disponibles",
      pricePerKg: "{price} {currency}/kg",
      recentJobs: "Jobs recentes",
      recentMissions: "Missões y oportunidades disponibles.",
      upcomingEvents: "Próximos eventos",
      upcomingMeetups: "Encontros, workshops y formaciones.",
      online: "En línea",
      newsTitle: "Actualidad MOXT",
      readAll: "Ler tudo",
      noNews: "Ninguna notícia por ahora.",
      newsLink: "Ver la página de actualidad",
      emptyRecent: "Ningún conteúdo recente.",
      viewAria: "Ver {title}"
    },
    activity: {
      title: "A tu atividade MOXT",
      description: "Encontre as tus operaciones, conversaciones y seguimentos importantes num só lugar.",
      transfers: "Transferencias",
  ...
  transfers: {
    ...
    calculator: {
      ...
      rateNote: "1 {from} = {rate} {to}. Referência de {date}, con margem da plataforma de {margin}%."
    },
    dashboardCalc: {
    ...
    new: {
      ...
      dateUnavailable: "data indisponible",
      rateNote: "Taxa indicactiva · fonte {source} · {date} · margem {margin}%. O importe recebido pode variar ligeiramente.",
      ...
      noFavoriteProfiles: "Ningún perfil favorito para este país. Completa manualmente.",
      errors: {
